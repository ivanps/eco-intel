...
We read the data from the Excel *file Ecological Scale.xlsx* that is in the *Data* folder. We also code the scale variables.

```{r, echo=TRUE}
dfenc <- read.xlsx(xlsxFile = "../Data/Ecologial Scale.xlsx", 
...
We construct a table to describe the demographic characteristics of the surveyed students.
...
Now we compute the indicators and its descriptive statistics.
